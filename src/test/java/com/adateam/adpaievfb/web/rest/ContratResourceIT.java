...
class ContratResourceIT {
    ...
    private static final TypeJourTravail DEFAULT_TYPE_JOUR_TRAVAIL = TypeJourTravail.Ouvre;
    private static final TypeJourTravail UPDATED_TYPE_JOUR_TRAVAIL = TypeJourTravail.Ouvrable;
    ...
    public static Contrat createEntity(EntityManager em) {
        Contrat contrat = new Contrat()
            ...
            .typeJourTravail(DEFAULT_TYPE_JOUR_TRAVAIL)
    ...
    public static Contrat createUpdatedEntity(EntityManager em) {
        Contrat contrat = new Contrat()
            ...
            .typeJourTravail(UPDATED_TYPE_JOUR_TRAVAIL)
    ...
    void createContrat() throws Exception {
        ...
        assertThat(testContrat.getTypeJourTravail()).isEqualTo(DEFAULT_TYPE_JOUR_TRAVAIL);
        assertThat(testContrat.getDateDepart()).isEqualTo(DEFAULT_DATE_DEPART);
    }
    ...
    @Test
    @Transactional
    void checkTypeJourTravailIsRequired() throws Exception {
        int databaseSizeBeforeTest = contratRepository.findAll().size();
        // set the field null
        contrat.setTypeJourTravail(null);
    ...
    void getAllContrats() throws Exception {
        ...
        restContratMockMvc
            ...
            .andExpect(jsonPath("$.[*].typeJourTravail").value(hasItem(DEFAULT_TYPE_JOUR_TRAVAIL.toString())))
    ...
    void getContrat() throws Exception {
        ...
        restContratMockMvc
            ...
            .andExpect(jsonPath("$.typeJourTravail").value(DEFAULT_TYPE_JOUR_TRAVAIL.toString()))
    ...
    void putExistingContrat() throws Exception {
        ...
        assertThat(testContrat.getTypeJourTravail()).isEqualTo(UPDATED_TYPE_JOUR_TRAVAIL);
        assertThat(testContrat.getDateDepart()).isEqualTo(UPDATED_DATE_DEPART);
    }
