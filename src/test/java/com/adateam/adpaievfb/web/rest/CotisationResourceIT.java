...
class CotisationResourceIT {
    ...
    private static final Float DEFAULT_MULTIPLICATEUR_MIN = 1F;
    private static final Float UPDATED_MULTIPLICATEUR_MIN = 2F;

    private static final Float DEFAULT_MULTIPLICATEUR_MAX = 1F;
    private static final Float UPDATED_MULTIPLICATEUR_MAX = 2F;
    ...
    public static Cotisation createEntity(EntityManager em) {
        Cotisation cotisation = new Cotisation()
            ...
            .multiplicateurMin(DEFAULT_MULTIPLICATEUR_MIN)
            .multiplicateurMax(DEFAULT_MULTIPLICATEUR_MAX);
        return cotisation;
    }
    ...
    public static Cotisation createUpdatedEntity(EntityManager em) {
        Cotisation cotisation = new Cotisation()
            ...
            .multiplicateurMin(UPDATED_MULTIPLICATEUR_MIN)
            .multiplicateurMax(UPDATED_MULTIPLICATEUR_MAX);
        return cotisation;
    }
    ...
    void createCotisation() throws Exception {
        ...
        assertThat(testCotisation.getMultiplicateurMin()).isEqualTo(DEFAULT_MULTIPLICATEUR_MIN);
        assertThat(testCotisation.getMultiplicateurMax()).isEqualTo(DEFAULT_MULTIPLICATEUR_MAX);
    }
    ...
    void getAllCotisations() throws Exception {
        ...
        restCotisationMockMvc
            ...
            .andExpect(jsonPath("$.[*].multiplicateurMin").value(hasItem(DEFAULT_MULTIPLICATEUR_MIN.doubleValue())))
            .andExpect(jsonPath("$.[*].multiplicateurMax").value(hasItem(DEFAULT_MULTIPLICATEUR_MAX.doubleValue())));
    }
    ...
    void getCotisation() throws Exception {
        ...
        restCotisationMockMvc
            ...
            .andExpect(jsonPath("$.multiplicateurMin").value(DEFAULT_MULTIPLICATEUR_MIN.doubleValue()))
            .andExpect(jsonPath("$.multiplicateurMax").value(DEFAULT_MULTIPLICATEUR_MAX.doubleValue()));
    }
    ...
    void putExistingCotisation() throws Exception {
        ...
        assertThat(testCotisation.getMultiplicateurMin()).isEqualTo(UPDATED_MULTIPLICATEUR_MIN);
        assertThat(testCotisation.getMultiplicateurMax()).isEqualTo(UPDATED_MULTIPLICATEUR_MAX);
    }
