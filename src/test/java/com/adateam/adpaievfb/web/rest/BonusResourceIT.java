...
class BonusResourceIT {
    ...
    private static final LocalDate DEFAULT_BONUS_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_BONUS_DATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Bonus createEntity(EntityManager em) {
        Bonus bonus = new Bonus().nom(DEFAULT_NOM).montant(DEFAULT_MONTANT).bonusDate(DEFAULT_BONUS_DATE);
        return bonus;
    }
    ...
    public static Bonus createUpdatedEntity(EntityManager em) {
        Bonus bonus = new Bonus().nom(UPDATED_NOM).montant(UPDATED_MONTANT).bonusDate(UPDATED_BONUS_DATE);
        return bonus;
    }
    ...
    void createBonus() throws Exception {
        ...
        assertThat(testBonus.getBonusDate()).isEqualTo(DEFAULT_BONUS_DATE);
    }
    ...
    @Test
    @Transactional
    void checkBonusDateIsRequired() throws Exception {
        int databaseSizeBeforeTest = bonusRepository.findAll().size();
        // set the field null
        bonus.setBonusDate(null);
    ...
    void getAllBonuses() throws Exception {
        ...
        restBonusMockMvc
            ...
            .andExpect(jsonPath("$.[*].bonusDate").value(hasItem(DEFAULT_BONUS_DATE.toString())));
    }
    ...
    void getBonus() throws Exception {
        ...
        restBonusMockMvc
            ...
            .andExpect(jsonPath("$.bonusDate").value(DEFAULT_BONUS_DATE.toString()));
    }
    ...
    void putExistingBonus() throws Exception {
        ...
        updatedBonus.nom(UPDATED_NOM).montant(UPDATED_MONTANT).bonusDate(UPDATED_BONUS_DATE);
        ...
        assertThat(testBonus.getBonusDate()).isEqualTo(UPDATED_BONUS_DATE);
    }
    ...
    void fullUpdateBonusWithPatch() throws Exception {
        ...
        partialUpdatedBonus.nom(UPDATED_NOM).montant(UPDATED_MONTANT).bonusDate(UPDATED_BONUS_DATE);
