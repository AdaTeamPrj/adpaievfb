...
class FicheDePaieResourceIT {
    ...
    void createFicheDePaie() throws Exception {
        ...
        assertThat(testFicheDePaie.getDatePaiement()).isEqualTo(DEFAULT_DATE_PAIEMENT);
    ...
    void putExistingFicheDePaie() throws Exception {
        ...
        assertThat(testFicheDePaie.getDatePaiement()).isEqualTo(UPDATED_DATE_PAIEMENT);
    ...
    void partialUpdateFicheDePaieWithPatch() throws Exception {
        ...
        partialUpdatedFicheDePaie.endDate(UPDATED_END_DATE).datePaiement(UPDATED_DATE_PAIEMENT).salaireNet(UPDATED_SALAIRE_NET);
