...
import com.adateam.adpaievfb.repository.JobRepository;
...
class JobResourceIT {
    ...
    private static final Float DEFAULT_MIN_SALARY = 1F;
    private static final Float UPDATED_MIN_SALARY = 2F;

    private static final Float DEFAULT_MAX_SALARY = 1F;
    private static final Float UPDATED_MAX_SALARY = 2F;
