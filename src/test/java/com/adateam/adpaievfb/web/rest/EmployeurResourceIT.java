...
import com.adateam.adpaievfb.repository.EmployeurRepository;
import com.adateam.adpaievfb.service.EmployeurService;
...
class EmployeurResourceIT {
    ...
    private static final String DEFAULT_NUMERO_SIRET = "AAAAAAAAAAAAAA";
    private static final String UPDATED_NUMERO_SIRET = "BBBBBBBBBBBBBB";

    private static final String DEFAULT_NUM_APE = "AAAAA";
    private static final String UPDATED_NUM_APE = "BBBBB";

    private static final String DEFAULT_NUM_URSSAF = "AAAAAAAAAAAAAA";
    private static final String UPDATED_NUM_URSSAF = "BBBBBBBBBBBBBB";
