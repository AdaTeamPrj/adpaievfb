...
class CongeResourceIT {
    ...
    private static final TypeConge DEFAULT_TYPE_CONGE = TypeConge.RTT;
    private static final TypeConge UPDATED_TYPE_CONGE = TypeConge.CongePaye;

    private static final Float DEFAULT_CONGE_PAY = 1F;
    private static final Float UPDATED_CONGE_PAY = 2F;
    ...
    public static Conge createEntity(EntityManager em) {
        Conge conge = new Conge()
            ...
            .typeConge(DEFAULT_TYPE_CONGE)
            .congePay(DEFAULT_CONGE_PAY);
        return conge;
    }
    ...
    public static Conge createUpdatedEntity(EntityManager em) {
        Conge conge = new Conge()
            ...
            .typeConge(UPDATED_TYPE_CONGE)
            .congePay(UPDATED_CONGE_PAY);
        return conge;
    }
    ...
    void createConge() throws Exception {
        ...
        assertThat(testConge.getTypeConge()).isEqualTo(DEFAULT_TYPE_CONGE);
        assertThat(testConge.getCongePay()).isEqualTo(DEFAULT_CONGE_PAY);
    }
    ...
    void getAllConges() throws Exception {
        ...
        restCongeMockMvc
            ...
            .andExpect(jsonPath("$.[*].typeConge").value(hasItem(DEFAULT_TYPE_CONGE.toString())))
            .andExpect(jsonPath("$.[*].congePay").value(hasItem(DEFAULT_CONGE_PAY.doubleValue())));
    }
    ...
    void getConge() throws Exception {
        ...
        restCongeMockMvc
            ...
            .andExpect(jsonPath("$.typeConge").value(DEFAULT_TYPE_CONGE.toString()))
            .andExpect(jsonPath("$.congePay").value(DEFAULT_CONGE_PAY.doubleValue()));
    }
    ...
    void putExistingConge() throws Exception {
        ...
        assertThat(testConge.getTypeConge()).isEqualTo(UPDATED_TYPE_CONGE);
        assertThat(testConge.getCongePay()).isEqualTo(UPDATED_CONGE_PAY);
    }
