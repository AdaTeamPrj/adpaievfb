  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfbApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="adpaievfbApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfbApp.location.numeroRue')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.location.nomVoie')}
                id="location-nomVoie"
                name="nomVoie"
                data-cy="nomVoie"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.location.streetName')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.location.nomDepartement')}
                id="location-nomDepartement"
                name="nomDepartement"
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.location.nomRegion')}
                id="location-nomRegion"
                name="nomRegion"
                data-cy="nomRegion"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.location.employee')}
              ...
              <ValidatedField
                label={translate('adpaievfbApp.location.employeur')}
