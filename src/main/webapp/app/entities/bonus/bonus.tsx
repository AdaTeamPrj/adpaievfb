  ...
  return (
    <div>
      <h2 id="bonus-heading" data-cy="BonusHeading">
        <Translate contentKey="adpaievfbApp.bonus.home.title">Bonuses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adpaievfbApp.bonus.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/bonus/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="adpaievfbApp.bonus.home.createLabel">Create new Bonus</Translate>
          </Link>
        </div>
      </h2>
        ...
        {bonusList && bonusList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="adpaievfbApp.bonus.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.bonus.nom">Nom</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.bonus.montant">Montant</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.bonus.bonusDate">Bonus Date</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.bonus.contrat">Contrat</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {bonusList.map((bonus, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{bonus.nom}</td>
                  <td>{bonus.montant}</td>
                  <td>{bonus.bonusDate ? <TextFormat type="date" value={bonus.bonusDate} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adpaievfbApp.bonus.home.notFound">No Bonuses found</Translate>
            </div>
          )
        )}
      </div>
