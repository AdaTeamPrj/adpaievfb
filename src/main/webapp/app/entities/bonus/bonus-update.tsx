  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfbApp.bonus.home.createOrEditLabel" data-cy="BonusCreateUpdateHeading">
            <Translate contentKey="adpaievfbApp.bonus.home.createOrEditLabel">Create or edit a Bonus</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfbApp.bonus.nom')}
                id="bonus-nom"
                name="nom"
                data-cy="nom"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.bonus.montant')}
                id="bonus-montant"
                name="montant"
                data-cy="montant"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.bonus.bonusDate')}
                id="bonus-bonusDate"
                name="bonusDate"
                data-cy="bonusDate"
                type="date"
              ...
              <ValidatedField
                ...
                name="contrat"
                data-cy="contrat"
                label={translate('adpaievfbApp.bonus.contrat')}
                type="select"
              >
                <option value="" key="0" />
                {contrats
