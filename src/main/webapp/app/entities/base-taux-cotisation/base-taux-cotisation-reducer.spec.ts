...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './base-taux-cotisation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BASETAUXCOTISATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BASETAUXCOTISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BASETAUXCOTISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BASETAUXCOTISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BASETAUXCOTISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BASETAUXCOTISATION actions', async () => {
      const expectedActions = [
        {
