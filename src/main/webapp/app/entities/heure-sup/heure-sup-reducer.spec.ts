...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './heure-sup.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HEURESUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_HEURESUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HEURESUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HEURESUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HEURESUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HEURESUP actions', async () => {
      const expectedActions = [
        {
