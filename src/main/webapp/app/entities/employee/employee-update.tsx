  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfbApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="adpaievfbApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfbApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('adpaievfbApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.employee.numeroSecuriteSociale')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.employee.qualification')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.employee.tauxImposition')}
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('adpaievfbApp.employee.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                label={translate('adpaievfbApp.employee.job')}
                id="employee-job"
                data-cy="job"
                type="select"
                multiple
