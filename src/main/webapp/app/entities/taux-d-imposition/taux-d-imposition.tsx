  ...
  return (
    <div>
      <h2 id="taux-d-imposition-heading" data-cy="TauxDImpositionHeading">
        <Translate contentKey="adpaievfbApp.tauxDImposition.home.title">Taux D Impositions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adpaievfbApp.tauxDImposition.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/taux-d-imposition/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="adpaievfbApp.tauxDImposition.home.createLabel">Create new Taux D Imposition</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tauxDImpositionList && tauxDImpositionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="adpaievfbApp.tauxDImposition.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.tauxDImposition.taux">Taux</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.tauxDImposition.minSalary">Min Salary</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.tauxDImposition.maxSalary">Max Salary</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.tauxDImposition.startDate">Start Date</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.tauxDImposition.endDate">End Date</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adpaievfbApp.tauxDImposition.home.notFound">No Taux D Impositions found</Translate>
            </div>
          )
        )}
      </div>
