  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfbApp.tauxDImposition.home.createOrEditLabel" data-cy="TauxDImpositionCreateUpdateHeading">
            <Translate contentKey="adpaievfbApp.tauxDImposition.home.createOrEditLabel">Create or edit a TauxDImposition</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfbApp.tauxDImposition.taux')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.tauxDImposition.minSalary')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.tauxDImposition.maxSalary')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.tauxDImposition.startDate')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.tauxDImposition.endDate')}
