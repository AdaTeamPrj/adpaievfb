  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfbApp.ficheDePaie.home.createOrEditLabel" data-cy="FicheDePaieCreateUpdateHeading">
            <Translate contentKey="adpaievfbApp.ficheDePaie.home.createOrEditLabel">Create or edit a FicheDePaie</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfbApp.ficheDePaie.salaireBrut')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.ficheDePaie.startDate')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.ficheDePaie.endDate')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.ficheDePaie.datePaiement')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.ficheDePaie.salaireNet')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.ficheDePaie.montantNetAvantImpots')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.ficheDePaie.proFees')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.ficheDePaie.deductions')}
              ...
              <ValidatedField
                ...
                name="contrat"
                data-cy="contrat"
                label={translate('adpaievfbApp.ficheDePaie.contrat')}
                type="select"
              >
                <option value="" key="0" />
                {contrats
              ...
              <ValidatedField
                ...
                name="employeur"
                data-cy="employeur"
                label={translate('adpaievfbApp.ficheDePaie.employeur')}
                type="select"
              >
                <option value="" key="0" />
                {employeurs
              ...
              <ValidatedField
                ...
                name="imposition"
                data-cy="imposition"
                label={translate('adpaievfbApp.ficheDePaie.imposition')}
                type="select"
              >
                <option value="" key="0" />
                {tauxDImpositions
              ...
              <ValidatedField
                label={translate('adpaievfbApp.ficheDePaie.cotisation')}
              ...
              <ValidatedField
                label={translate('adpaievfbApp.ficheDePaie.mentionsObligatoires')}
