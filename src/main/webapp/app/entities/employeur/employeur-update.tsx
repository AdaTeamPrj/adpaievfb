  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adpaievfbApp.employeur.home.createOrEditLabel" data-cy="EmployeurCreateUpdateHeading">
            <Translate contentKey="adpaievfbApp.employeur.home.createOrEditLabel">Create or edit a Employeur</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('adpaievfbApp.employeur.name')}
                id="employeur-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.employeur.numeroSiret')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.employeur.numApe')}
                id="employeur-numApe"
                name="numApe"
                data-cy="numApe"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.employeur.numUrssaf')}
              ...
              />
              <ValidatedField
                label={translate('adpaievfbApp.employeur.conventionCollective')}
