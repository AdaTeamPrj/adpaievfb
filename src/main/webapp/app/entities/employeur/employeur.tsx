  ...
  return (
    <div>
      <h2 id="employeur-heading" data-cy="EmployeurHeading">
        <Translate contentKey="adpaievfbApp.employeur.home.title">Employeurs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adpaievfbApp.employeur.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/employeur/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="adpaievfbApp.employeur.home.createLabel">Create new Employeur</Translate>
          </Link>
        </div>
      </h2>
        ...
        {employeurList && employeurList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="adpaievfbApp.employeur.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.employeur.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.employeur.numeroSiret">Numero Siret</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.employeur.numApe">Num Ape</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.employeur.numUrssaf">Num Urssaf</Translate>
                </th>
                <th>
                  <Translate contentKey="adpaievfbApp.employeur.conventionCollective">Convention Collective</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adpaievfbApp.employeur.home.notFound">No Employeurs found</Translate>
            </div>
          )
        )}
      </div>
