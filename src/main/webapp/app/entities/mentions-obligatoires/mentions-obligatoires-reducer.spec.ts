...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './mentions-obligatoires.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENTIONSOBLIGATOIRES_LIST actions', async () => {
    ...
    it('dispatches FETCH_MENTIONSOBLIGATOIRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MENTIONSOBLIGATOIRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MENTIONSOBLIGATOIRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MENTIONSOBLIGATOIRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MENTIONSOBLIGATOIRES actions', async () => {
      const expectedActions = [
        {
