...
import reducer, { getEntities, getEntity, reset } from './indicateurs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDICATEURS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INDICATEURS actions', async () => {
      const expectedActions = [
        {
