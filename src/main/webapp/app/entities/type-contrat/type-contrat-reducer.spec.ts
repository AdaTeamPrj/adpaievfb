...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPECONTRAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TYPECONTRAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TYPECONTRAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TYPECONTRAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TYPECONTRAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TYPECONTRAT actions', async () => {
      const expectedActions = [
        {
