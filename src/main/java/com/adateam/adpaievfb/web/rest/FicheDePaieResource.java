...
/**
 * REST controller for managing {@link com.adateam.adpaievfb.domain.FicheDePaie}.
 */
@RestController
@RequestMapping("/api")
public class FicheDePaieResource {
    ...
    public ResponseEntity<FicheDePaie> createFicheDePaie(@RequestBody FicheDePaie ficheDePaie) throws URISyntaxException {
