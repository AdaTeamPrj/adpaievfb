...
import com.adateam.adpaievfb.domain.enumeration.Categorie;
...
public class Cotisation implements Serializable {
    ...
    @Column(name = "multiplicateur_min")
    private Float multiplicateurMin;

    @Column(name = "multiplicateur_max")
    private Float multiplicateurMax;
    ...
    public Float getMultiplicateurMin() {
        return this.multiplicateurMin;
    }

    public Cotisation multiplicateurMin(Float multiplicateurMin) {
        this.setMultiplicateurMin(multiplicateurMin);
        return this;
    }

    public void setMultiplicateurMin(Float multiplicateurMin) {
        this.multiplicateurMin = multiplicateurMin;
    }

    public Float getMultiplicateurMax() {
        return this.multiplicateurMax;
    }

    public Cotisation multiplicateurMax(Float multiplicateurMax) {
        this.setMultiplicateurMax(multiplicateurMax);
        return this;
    }

    public void setMultiplicateurMax(Float multiplicateurMax) {
        this.multiplicateurMax = multiplicateurMax;
    }

    public BaseTauxCotisation getBaseTauxCotisation() {
        return this.baseTauxCotisation;
    }

    public void setBaseTauxCotisation(BaseTauxCotisation baseTauxCotisation) {
        this.baseTauxCotisation = baseTauxCotisation;
    }

    public Cotisation baseTauxCotisation(BaseTauxCotisation baseTauxCotisation) {
        this.setBaseTauxCotisation(baseTauxCotisation);
        return this;
    }
    ...
    public Set<TypeContrat> getTypeContrats() {
        return this.typeContrats;
    }

    public void setTypeContrats(Set<TypeContrat> typeContrats) {
        if (this.typeContrats != null) {
            this.typeContrats.forEach(i -> i.removeCotisation(this));
        }
        if (typeContrats != null) {
            typeContrats.forEach(i -> i.addCotisation(this));
        }
        this.typeContrats = typeContrats;
    }

    public Cotisation typeContrats(Set<TypeContrat> typeContrats) {
        this.setTypeContrats(typeContrats);
        return this;
    }

    public Cotisation addTypeContrat(TypeContrat typeContrat) {
        this.typeContrats.add(typeContrat);
        typeContrat.getCotisations().add(this);
        return this;
    }

    public Cotisation removeTypeContrat(TypeContrat typeContrat) {
        this.typeContrats.remove(typeContrat);
        typeContrat.getCotisations().remove(this);
        return this;
    }
    ...
    public String toString() {
        return "Cotisation{" +
            ...
            ", endDate='" + getEndDate() + "'" +
            ", actuel='" + getActuel() + "'" +
            ", multiplicateurMin=" + getMultiplicateurMin() +
            ", multiplicateurMax=" + getMultiplicateurMax() +
            "}";
    }
}
