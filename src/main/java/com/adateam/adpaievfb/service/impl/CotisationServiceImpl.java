...
import com.adateam.adpaievfb.service.CotisationService;
    ...
    public Optional<Cotisation> partialUpdate(Cotisation cotisation) {
        ...
        return cotisationRepository
            ...
            .map(existingCotisation -> {
                ...
                if (cotisation.getMultiplicateurMin() != null) {
                    existingCotisation.setMultiplicateurMin(cotisation.getMultiplicateurMin());
                }
                if (cotisation.getMultiplicateurMax() != null) {
                    existingCotisation.setMultiplicateurMax(cotisation.getMultiplicateurMax());
                }
