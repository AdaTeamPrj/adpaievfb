...
import com.adateam.adpaievfb.service.ConventionCollectiveService;
    ...
    public Optional<ConventionCollective> partialUpdate(ConventionCollective conventionCollective) {
        ...
        return conventionCollectiveRepository
            ...
            .map(existingConventionCollective -> {
                ...
                if (conventionCollective.getSalaireMinimal() != null) {
                    existingConventionCollective.setSalaireMinimal(conventionCollective.getSalaireMinimal());
                }
