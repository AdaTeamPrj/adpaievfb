...
import com.adateam.adpaievfb.service.ContratService;
    ...
    public Optional<Contrat> partialUpdate(Contrat contrat) {
        ...
        return contratRepository
            ...
            .map(existingContrat -> {
                ...
                if (contrat.getTypeJourTravail() != null) {
                    existingContrat.setTypeJourTravail(contrat.getTypeJourTravail());
                }
                if (contrat.getDateDepart() != null) {
                    existingContrat.setDateDepart(contrat.getDateDepart());
                }
